...
export const Nav3 = () => {
  ...
  <div className='lg:hidden block absolute top-16 w-full left-0 ring-0 bg-black' >
    <ul className='text-center text-xl p-20'>
      ...
      <li className='my-4 py-4 border-b border-black hover:bg-red-500 hover:rounded'>Home</li>
      </Link>
      <Link spy={true} smooth={true} to='OurService'>
      <li className='my-4 py-4 border-b border-black hover:bg-red-500 hover:rounded'>Nuestros servicios</li>
      </Link>
      <Link spy={true} smooth={true} to='Contact'>
      <li className='my-4 py-4 border-b border-black hover:bg-red-500 hover:rounded'>contacto</li>
      </Link>
      <Link spy={true} smooth={true} to='About'>
      <li className='my-4 py-4 border-b border-black hover:bg-red-500 hover:rounded'>Sobre nosotros</li>
      </Link>
    </ul>
  </div>
  </>
